...
use sp_runtime::traits::{
	self, BlakeTwo256, Block as BlockT, ConvertInto, NumberFor, OpaqueKeys, SaturatedConversion, Saturating,
	StaticLookup,
};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("ipse-node"),
	impl_name: create_runtime_str!("ipse-node"),
	authoring_version: 10,
	// Per convention: if the runtime behavior changes, increment spec_version
	// and set impl_version to 0. If only runtime
	// implementation changes and behavior does not, then leave spec_version as
	// is and increment impl_version.
	spec_version: 2021100601,
	impl_version: 1,
...
parameter_types! {
	...
	pub const NoLimit: BlockNumber = u32::MAX;
...
parameter_types! {
	...
	pub const MinBondAmount: Balance = 10 * DOLLARS;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		FinalityTracker: pallet_finality_tracker::{Module, Call, Inherent, Storage},
