...
use node_runtime::{
	wasm_binary_unwrap, AuthorityDiscoveryConfig, BabeConfig, BalancesConfig, ContractsConfig, CouncilConfig,
	DemocracyConfig, ElectionsPhragmenConfig, ExchangeConfig, GrandpaConfig, ImOnlineConfig, IndicesConfig,
...
pub fn main_net_config() -> ChainSpec {
	let boot_nodes = vec![
		String::from("/dns/mainnet-usa.ipse.io/tcp/30333/p2p/12D3KooWD6sBdRYgkzaFCVhGXUbsgkKYcK4cj2r9fbSgSnGXyJxT")
			.try_into()
			.unwrap(),
		String::from("/dns/mainnet-china.ipse.io/tcp/30333/p2p/12D3KooWD6sBdRYgkzaFCVhGXUbsgkKYcK4cj2r9fbSgSnGXyJxT")
			.try_into()
			.unwrap(),
		String::from("/dns/mainnet-europe.ipse.io/tcp/30333/p2p/12D3KooWD6sBdRYgkzaFCVhGXUbsgkKYcK4cj2r9fbSgSnGXyJxT")
			.try_into()
			.unwrap(),
	];
...
pub fn testnet_genesis(
	...
	GenesisConfig {
		...
		exchange: Some(ExchangeConfig {
			notary_keys: vec![hex!["d43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d"].into()],
...
fn get_staging_initial_authorities() -> Vec<(
	AccountId,
	AccountId,
	GrandpaId,
	BabeId,
	...
	let initial_authorities = vec![
		(
			...
			hex!["91f60f93f06e1fdc057f56176a726290ae0c63705af42413a54e3ddaf62b8a81"].unchecked_into(),
			// 5F49xULpJFZVCyuPNMbPM1cHNaBemhDgUBeVeju1mY8KqiAB
			hex!["844950ca6191cf1bf094c667a8d8325049b63ff6266004923b83f7cffc355808"].unchecked_into(),
			// 5EFnQ5feZ1WJ2CzwRQSD6VgpAwNjCYm2dWodDwegL9WcSYfq
			hex!["60eb7468ed2e6f3d9202779e4d4f453c7715d750d12fbf952a8e2154d4a85126"].unchecked_into(),
			// 5E7ZbP6SYZVvKHv8Ucg1DZvFjqUsAf2iff3bFBrZpRfSLrcW
			hex!["5aa662ade2ae26abecf68fd36428de6ccc0f90a2752fed0eb89707376b57883f"].unchecked_into(),
		),
		(
			...
			hex!["6085a28e9334aa863a7cb7676b4a4eaf1070eadb0cbebfca40cdb400f3c44b45"].unchecked_into(),
			// 5E6m945UX7Verbnf36uDejWy7TQzVnxu4FSocjvHNJaLGeMP
			hex!["5a0a01f22da54bb6dfdc47e43d5d505a9f1470bde22827c9f04aaefa36ad7149"].unchecked_into(),
			// 5GTN2JEJ5KWEwARJKZ3bTesZX87gphCiLzydUS1bKfvXykDR
			hex!["c238cf9c7cff72b36ad7adf4cb74b1d77f50463e9c9520249ecc9c1539a0e076"].unchecked_into(),
			// 5CY3uMvTg2vx7NcxLyH9JeJLHzbJN2WZiUYri6YcSQHwHNT9
			hex!["14db1bb37d60c5c0912be231a8516f47fcce7375de310c9c5c415284fe5f096a"].unchecked_into(),
		),
		(
			...
			hex!["e4171e2fd1c49f82257310cf21837aef11b5b86b8757ec44c081e36b6c44ba2e"].unchecked_into(),
			// 5EExkknokfbq2RFdfR5yuWogCSGr5vhGMo9EPuGkuddSc2ho
			hex!["604b12800205ef5a6c59d27a64bb2eaedc0ba7feea8ef7704d958e285f41d564"].unchecked_into(),
			// 5CnhFw8grMmGEjqcsadUGdPo4CTDJqRwDQE6UsEE8mcr4kYk
			hex!["20064a7ed907cc8494fcc4e3c317eb1ad1be983f7848c12b79cd4c63c0870d37"].unchecked_into(),
			// 5DyPjbBTyB7bLAL1aEK2iQVCas6PM13awBGPwtaK98t6qAjD
			hex!["546b3c530d76f1b312bd1ad098451a35924a26b70793a5ec80bcd4e585078a34"].unchecked_into(),
		),
		(
			...
			hex!["c5e086627b2c950eebcc6aba173560f3ffb184818172f10d398437179faf995e"].unchecked_into(),
			// 5FZKDnd6XtfVHR6GMW5je1DEctb5fMfAAFpyrpSHgNGhKFTY
			hex!["9a869e2ee8fed7306841ec2e66763966834c816d5c724e269c431a7aa33eb06f"].unchecked_into(),
			// 5CXnt7ErGmEu9asrx5xmDxQpbhwgKh3ExXPL78XVubkKnVa9
			hex!["14a88a7d420bedda32f6854a758f1352a6ac1357645640b12f67486c7cd11a49"].unchecked_into(),
			// 5FpPVM8dyStQ9RQ1j5XBRo15k7LSdFfSi1r3DsNM1SncuXAd
			hex!["a605aad3dfb8dfdd8036983cfc3265c81e5f621c9698047db1eebe7bf1550935"].unchecked_into(),
		),
	];
	initial_authorities
}
