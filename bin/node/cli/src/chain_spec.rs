...
pub fn ipse_testnet_config() -> Result<ChainSpec, String> {
...
fn get_staging_initial_authorities() -> Vec<(AccountId, AccountId, GrandpaId, BabeId, ImOnlineId, AuthorityDiscoveryId)> {
