...
pub trait BlockBuilderExt {
	...
	fn push_storage_change(&mut self, key: Vec<u8>, value: Option<Vec<u8>>) -> Result<(), sp_blockchain::Error>;
...
impl<'a, A, B> BlockBuilderExt for sc_block_builder::BlockBuilder<'a, substrate_test_runtime::Block, A, B>
where
	...
	A::Api: BlockBuilderApi<substrate_test_runtime::Block, Error = sp_blockchain::Error>
		+ ApiExt<substrate_test_runtime::Block, StateBackend = backend::StateBackendFor<B, substrate_test_runtime::Block>>,
