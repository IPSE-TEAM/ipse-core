...
pub trait SystemApi<Hash, Number> {
	...
	fn system_peers(&self) -> Compat<BoxFuture<'static, jsonrpc_core::Result<Vec<PeerInfo<Hash, Number>>>>>;
	...
	fn system_network_state(&self) -> Compat<BoxFuture<'static, jsonrpc_core::Result<jsonrpc_core::Value>>>;
	...
	fn system_add_reserved_peer(&self, peer: String) -> Compat<BoxFuture<'static, Result<(), jsonrpc_core::Error>>>;
