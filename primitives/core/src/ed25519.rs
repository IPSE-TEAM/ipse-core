...
impl TraitPair for Pair {
	...
	fn from_seed_slice(seed_slice: &[u8]) -> Result<Pair, SecretStringError> {
		let secret =
			ed25519_dalek::SecretKey::from_bytes(seed_slice).map_err(|_| SecretStringError::InvalidSeedLength)?;
...
mod test {
	...
	fn test_vector_should_work() {
		...
		assert_eq!(
			public,
			Public::from_raw(hex!("d75a980182b10ab7d54bfed3c964073a0ee172f3daa62325af021a68f707511a"))
		);
		let message = b"";
	...
	fn seeded_pair_should_work() {
		...
		assert_eq!(
			public,
			Public::from_raw(hex!("2f8c6129d816cf51c374bc7f08c3e63ed156cf78aefb4a6550d97b87997977ee"))
		);
