...
use sp_state_machine::{create_proof_check_backend, execution_proof_check_on_trie_backend, ExecutionStrategy};
use substrate_test_runtime_client::{
	prelude::*,
	runtime::{Block, DecodeFails, TestAPI, Transfer},
...
#[test]
#[should_panic(expected = "Could not convert parameter `param` between node and runtime: DecodeFails always fails")]
...
fn record_proof_works() {
	...
	let backend = create_proof_check_backend::<HashFor<Block>>(storage_root, proof.expect("Proof was generated"))
